...
%	\begin{align*}
%        \int_\Gamma f \;d\ell
%        &= \int_0^1 \sqrt{16t^6 + 1} \; dt = \int \sqrt{\tan^2\theta + 1} \frac{1}{4}\sec^2\theta \; d\theta = \int\frac{1}{4}\sec^3\theta \; d\theta\\
%	&= \left[\frac{1}{8}(\sec\theta\tan\theta + \ln |\sec\theta+\tan\theta|)\right] = \left[\frac{1}{8}(\sqrt{1+16t^3}4t^3 + \ln|\sqrt{1+16t^3} + 4t^3|)\right]_0^1 \\
