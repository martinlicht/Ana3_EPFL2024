...
We point out that strictly speaking, this is not the Fourier series of $u$, since the sine terms are of period $2L$ instead of $L$. However, both series could be converted into Fourier series over $[0, L]$ and we would retrieve the same result.
\end{solution}
