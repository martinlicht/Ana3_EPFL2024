...
\end{exercise}
\begin{solution}     
The surface is parameterized by \begin{gather*}\Omega := [0,\pi]\times[0,\frac{\pi}{2}] \mapsto S: (\theta, \phi) \mapsto (\cos\theta\sin\phi, \sin\theta\sin\phi, \cos\phi)\end{gather*}
