...
\begin{solution}     
    ...
    \begin{align}
        ...
        .
    \end{align}
    The norm of this cross product equals $\sin\phi$. Hence 
    \begin{gather*}
        \vec{n} = \frac{\partial_{\theta}\Phi\times \partial_{\phi}\Phi}{||\partial_{\theta}\Phi\times \partial_{\phi}\Phi||} 
        = 
    ...
    \begin{gather*}
        \gamma : [0,2\pi) \mapsto \partial \Omega, \quad \theta \mapsto(\theta, \frac{\pi}{2}),
    \end{gather*}
    ...
    \begin{align*}
        ...
        \cdot
        \begin{pmatrix} -\cos\theta\sin\phi \\ -\sin\theta\sin\phi \\ -\cos\phi\end{pmatrix} \sin\phi \ d\sigma
        \\&
        = 
