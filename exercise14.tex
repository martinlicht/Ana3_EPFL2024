...
\begin{solution}
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            = 
            2 \left[ \frac{(x-\tfrac 1 2)^{2}}{2} \right]_{x=0}^{x=1}
            =
            \left( (1-\tfrac 1 2)^{2} - (0-\tfrac 1 2)^{2} \right)
            =
            0
            .
        \end{align*}
        ...
        \begin{align*}
            a^{f}_n 
            &= 
            2\int_{0}^{1} \left( x- \frac 1 2 \right) \cos(2 \pi n x) \ dx 
            \\&= 
            2\left[ \left( x- \frac 1 2 \right) \frac{1}{2 \pi n} \sin(2 \pi n x) \right]_{x=0}^{x=1}
            -
            \frac{2}{2 \pi n} \int_{0}^{1} \left( x- \frac 1 2 \right)' \sin(2 \pi n x) \ dx 
            \\&= 
            2\left[ \left( x- \frac 1 2 \right) \frac{1}{2 \pi n} \sin(2 \pi n x) \right]_{x=0}^{x=1}
            -
            \frac{2}{2 \pi n} \int_{0}^{1} \sin(2 \pi n x) \ dx 
            \\&
            =
            0
            .
        \end{align*}
        Notice that $x-\tfrac 1 2$ has zero average, hence $a_0 = 0$.
        The higher cosine modes of $f_{per}$ do not see the constant, and thus agree with the $1$-periodic extension of $f$, which is odd, and hence the higher cosine modes have coefficient zero as well. 
        We have 
        \begin{align*}
            b^{f}_n 
            &= 
