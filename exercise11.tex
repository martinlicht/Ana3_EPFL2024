...
\begin{solution}     
    ...
    \begin{align*}
        ...
        \\&
        =
        \frac{\sin((n-1)\frac{\pi}{2})}{\pi(n-1)} - \frac{\sin((n+1)\frac{\pi}{2})}{\pi(n+1)}
    \end{align*}
    ...
    if $n=2,6,10,\dots$, then 
    \begin{align*}
        b_n = \frac{1}{\pi(n-1)} - \frac{-1}{\pi(n+1)} = \frac{1}{\pi(n-1)} + \frac{1}{\pi(n+1)} = \frac{2n}{\pi(n^2+1)}.
    \end{align*}
    if $n=4,8,12,\dots$, then 
    \begin{align*}
        b_n = \frac{-1}{\pi(n-1)} - \frac{ 1}{\pi(n+1)} = \frac{-2n}{\pi(n^2+1)}.
    \end{align*}
