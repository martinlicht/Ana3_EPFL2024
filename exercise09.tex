...
\begin{solution}     
    \begin{itemize}
    \item To compute the Fourier coefficients of $f(x)$ over the interval $[0,1)$ with a period of $1$, use the formulas from the lecture:
    \[
        a_0 
        = 
...
% <<<<<<< HEAD
    ...
    \begin{align*}
        ...
        .
    \end{align*}
    However, $z^3 \cos(nz)$ is the product of an odd and an even function, and so the integral vanishes. Explicitly:
    \begin{align*}
	...
	\\&\implies
            ...
            -\frac{\pi^3}{n}-\frac{6\pi(-1)^n}{n^3}   ,\quad &\text{if } n\text{ is even,}
            \end{cases}
    \end{align*}
% 
% 
